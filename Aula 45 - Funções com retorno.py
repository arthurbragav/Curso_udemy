...
OBS: Funções em Python que retornam valores, devem usar a palavra reservada return
...
def diz_oi():
    ...
    return 'Oi! '
    print('Estou sendo executado após o return...') # Nunca será executado
...
def joga_moeda():
    # Gera um número pseudorandomico entre 0 e 1
    if random() > 0.5:
        return 'Cara'
    return 'Coroa'
...
def eh_impar():
    ...
    if numero % 2 != 0:
        return True
    else:  # Desnecessário o else, pois só temos duas possibilidades
        return False
